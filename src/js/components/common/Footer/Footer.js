      ...
      <div className="footer-region-1">
        <div className="sticky-footer">
         ...
         <div className="col-md-4 footer-text row nopadding">
            ...
            <div className="col-md-1 nopadding centre">
              <a href ="https://www.youtube.com/user/TheBodyShopUK">
                <img src ={youtube} className="footericons"/>
              </a>
            </div>
            <div className="col-md-1 nopadding" />
            <div className="col-md-1 nopadding centre">
              <a href ="https://www.snapchat.com/add/thebodyshopuk">
    ...
    <div className = "col-md-11 row nopadding">
      <div className="col-md-3 nopadding">
            <ul className = "list footer-text-2">
              ...
              <li ><strong ><a href ="" className="live-link"><FormattedMessage id="footer.live" defaultmessage="LIVE CHAT"  /></a></strong></li>
      ...
      <div className = "col-md-3 nopadding">
       <ul className = "list footer-text-2">
          ...
          <li><a href="" className="footer-links"><FormattedMessage id="footer.loyalty" defaultmessage = "Loyalty Club" /></a></li>
      ...
      <div className = "col-md-3 nopadding">
       <ul className = "list footer-text-2">
          ...
          <li ><a href="" className="footer-links"><FormattedMessage id="footer.aboutus" defaultmessage = "About us" /></a></li>
          <li ><a href="" className="footer-links"><FormattedMessage id="footer.gender" defaultmessage = "Gender Pay Gap" /></a></li>
